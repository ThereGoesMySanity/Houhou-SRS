        ...
        switch (e.Key)
        {
            ...
            case Key.M:
            {
                if (isCtrlDown)
                {
                    ...
                    var filterTextBox =
                        ((Control)FilterControl.MeaningFilter.GetVisualChildren().FirstOrDefault())?.FindControl<CommandTextBox>("FilterTextBox");
            ...
            case Key.R:
            {
                ...
                {
                    var filterTextBox =
                        ((Control)FilterControl.ReadingFilter.GetVisualChildren().FirstOrDefault())?.FindControl<CommandTextBox>("FilterTextBox");
                    filterTextBox.Focus();
                    e.Handled = true;
                }
                break;
            ...
            case Key.T:
            {
                ...
                {
                    var filterTextBox =
                        ((Control)FilterControl.TagFilter.GetVisualChildren().FirstOrDefault())?.FindControl<CommandTextBox>("FilterTextBox");
