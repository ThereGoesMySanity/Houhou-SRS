...
//{
//    public class VirtualizingWrapPanel : WrapPanel, IVirtualizingPanel, ILogicalScrollable
//    {

//        #region Fields

//        Avalonia.Controls.Controls _children;
...
//        Dictionary<IControl, Rect> _realizedChildLayout = new Dictionary<IControl, Rect>();
...
//        protected override void ChildrenChanged(object sender, NotifyCollectionChangedEventArgs args)
//        {
//            base.ChildrenChanged(sender, args);
//            _abstractPanel = null;
//            ResetScrollInfo();
//        }
...
//        {
//            if (_itemsControl == null || _itemsControl.ItemCount == 0)
...
//            if (_children != null)
//            {
//                foreach (IControl child in _children)
//                {
...
//        #region VirtualizingWrapPanel Members
...
//        public bool BringIntoView(IControl visual, Rect rectangle)
//        {
//            bool offsetChanged = rectangle.Position != _offset;
